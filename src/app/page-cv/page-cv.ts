...
export class PageCv {
	...
	protected readonly employmentHistory: Employment[] = [
		{
			...
			description:
				"Developing dynamic web applications and responsible for the lifecycle of the application from agile development, managing deployments, servers, APIs, and services through to testing, CI/CD, and monitoring.",
			organisation: "Pxel",
		...
		},
		{
			...
			description:
				"Managed the Social Analytics Lab at Griffith University, a research lab that stored, managed, and analysed administrative data from several Queensland Government agencies for social science research. This involved compiling data for projects, managing user and project approvals, physical and computer access. Maintaining IT infrastructure, software, data, and security systems.",
		...
		},
		{
			...
			description:
				"Responsible for the delivery of the Server Refresh Project to upgrade out of warranty physical server hardware and upgrade unsupported Windows Server OS versions.",
			organisation: "Griffith University",
		...
		},
		{
			...
			description:
				"Support of nearly one thousand Windows VM servers across two Data Centres at Griffith University.",
			organisation: "Griffith University",
	...
	protected readonly honoursAndAchievements: Education[] = [
		{
			year: new Date("2018-01-01"),
			title: "Sustained Performance Award",
			institution: "Griffith University - ITI Director Recognition",
		},
		{
			year: new Date("2017-01-01"),
			title: "Systems Administrator of the Month",
			institution: "Griffith University - S3 Team Recognition",
		},
		{
			year: new Date("2012-01-01"),
			title: "Outstanding Client Service",
			institution: "Griffith University - ICTS Staff Recognition",
		},
